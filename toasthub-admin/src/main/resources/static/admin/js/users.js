...
adminUsers.prototype = Object.create(toastHubUsers.prototype);
adminUsers.prototype.constructor = adminUsers;

toastHub.registerController("users",new adminUsers("users"));

function adminUsers(instanceName){
	toastHubUsers.call(this,instanceName,this);
...
adminLanguage.prototype = Object.create(toastHubLanguage.prototype);
adminLanguage.prototype.constructor = adminLanguage;

toastHub.registerWidget("language",new adminLanguage("language"));

function adminLanguage(instanceName){
	toastHubLanguage.call(this,instanceName,this);
