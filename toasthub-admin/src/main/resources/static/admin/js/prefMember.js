...
PrefMember.prototype = Object.create(toastHubPreference.prototype);
PrefMember.prototype.constructor = PrefMember;

toastHub.registerController("prefMember",new PrefMember("perfMember"));

function PrefMember(instanceName){
	toastHubPreference.call(this,instanceName,this);
	this.category = "MEMBER";
	var self = this;
	
	this.initCustom = function(params){
		toastHub.logSystem.log("DEBUG","prefMember::PrefMember::initCustom");
